  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <AuthImagePattern
        ...
        subtitle="Connect with friends, share moments, and stay in touch with your loved ones. Created by Sourabh"
      />

      {/* Branding Icons */}
      <div className="block lg:hidden">
        <div className="flex flex-col items-center justify-center gap-4 mt-6 lg:mt-12">
          <div className="flex justify-center gap-4">
            <a href="https://linkedin.com/in/sourabh-jha-b79869321?" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary-focus">
            ...
            <a href="https://github.com/Its-Sourabh74" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary-focus">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.387.6.113.82-.258.82-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.757-1.333-1.757-1.089-.744.083-.729.083-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.775.418-1.305.762-1.605-2.665-.305-5.466-1.332-5.466-5.93 0-1.31.469-2.381 1.236-3.221-.123-.303-.536-1.523.117-3.176 0 0 1.008-.322 3.3 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.29-1.552 3.297-1.23 3.297-1.23.653 1.653.24 2.873.118 3.176.77.84 1.234 1.911 1.234 3.221 0 4.61-2.805 5.623-5.475 5.921.43.372.823 1.102.823 2.222v3.293c0 .322.218.694.825.576 4.765-1.588 8.2-6.084 8.2-11.386 0-6.627-5.373-12-12-12z" />
              </svg>
            </a>
            <a href="https://instagram.com/Sourabh_ml" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary-focus">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-sm text-base-content/60 text-center">Made By Sourabh</p>
        </div>
      </div>
    </div>
  );
